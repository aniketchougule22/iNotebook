...
const About = () => {
  return (
    <div className="container accordion" id="accordionPanelsStayOpenExample">
      <h2 className="mb-3">Let's start with iNotebook</h2>
      ...
      <div className="accordion-item">
        ...
        >
          <div className="accordion-body">
            <strong>
              iNotebook App is fast, uses the original author's language, and
      ...
      <div className="accordion-item">
        ...
        >
          <div className="accordion-body">
            <strong>
              No matter where your ideas find you, a iNotebook app allows you to
              write them down.
            </strong>
      ...
      <div className="accordion-item">
        ...
        >
          <div className="accordion-body">
            <strong>
              iNotebook note-taking lets you customize your writing experience
      ...
      <div className="accordion-item">
        ...
        >
          <div className="accordion-body">
            iNotebook App Market size is growing at a moderate pace with
